...
atlas_dir_list = [d for d in glob(os.path.join(root_dir, "data/atlases/NMM_atlases/*")) if os.path.isdir(d)]
results_dir = os.path.join(root_dir, "data/results/results_NMM_atlases")
