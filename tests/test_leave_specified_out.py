...
for i in range(len(atlas_leaveout_list)):
    img_path = os.path.join(atlas_leaveout_list[i], 'srr_mni_aligned.nii.gz')
    mask_path = None  # these atlases don't have masks

    results_dir = "../data/results/results_NMM_atlases_leaveoneout/" + os.path.basename(atlas_leaveout_list[i])
