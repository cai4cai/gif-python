...
img_path = ROOT_DIR+"/data/input/BraTS2021/BraTS2021_00000/BraTS2021_00000_t1.nii.gz"
mask_path = ROOT_DIR+"/data/BraTS2021/input/BraTS2021_00000/BraTS2021_00000_inv-tumor-mask.nii.gz"
atlas_dir_list = [d for d in glob(ROOT_DIR+"/data/atlases/GENFI_atlases/*") if os.path.isdir(d)]
results_dir = ROOT_DIR+"/data/results/results_GENFI_atlases"
